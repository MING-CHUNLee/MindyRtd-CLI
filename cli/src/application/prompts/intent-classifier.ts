export const INTENT_CLASSIFIER_SYSTEM_PROMPT =
    ...
    '- "run" — the user wants to EXECUTE or RUN an R script or R Markdown file and see/analyze the output\n' +
    '- "install" — the user wants to INSTALL one or more R packages\n' +
